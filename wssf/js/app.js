...
const categories = [
    ...
    { id: 'industrialchain', name: '供应链', icon: 'fa-anchor' },
...
let database = [
   ...
   { category: 'catamaran', name: 'Xquisite', logo: 'images/xquisite.jpg', link: 'https://xquisiteyachts.com' },
    ...
    { category: 'industrialchain', name: 'Elvstrøm Sails', logo: 'images/elvstromsails.jpg', link: 'https://www.elvstromsails.com/' },
    { category: 'industrialchain', name: 'Marlow Ropes', logo: 'images/marlowropes.jpg', link: 'https://www.marlowropes.com/' },
    { category: 'industrialchain', name: 'Blue Shark', logo: 'images/blueshark.jpg', link: 'https://www.blueshark.cc/' },
    { category: 'industrialchain', name: 'Harken', logo: 'images/harken.jpg', link: 'https://www.harken.com/' },
    { category: 'industrialchain', name: 'Lewmar', logo: 'images/lewmar.jpg', link: 'https://www.lewmar.com/' },
    { category: 'industrialchain', name: 'Antal', logo: 'images/antal.jpg', link: 'https://www.antal.it/' },
    { category: 'industrialchain', name: 'Karver Systems', logo: 'images/karver.jpg', link: 'https://www.karver-systems.com/' },
    { category: 'industrialchain', name: 'Lofrans', logo: 'images/lofrans.jpg', link: 'https://www.lofrans.com/' },
    { category: 'industrialchain', name: 'Maxwell Marine', logo: 'images/maxwellmarine.jpg', link: 'https://www.maxwellmarine.com/' },
    { category: 'industrialchain', name: 'B&G', logo: 'images/bandg.jpg', link: 'https://www.bandg.com/' },
    { category: 'industrialchain', name: 'Raymarine', logo: 'images/raymarine.jpg', link: 'https://www.raymarine.com/' },
    { category: 'industrialchain', name: 'Simrad', logo: 'images/simrad-logo.jpg', link: 'https://www.simrad-yachting.com/' },
    { category: 'industrialchain', name: 'Furuno', logo: 'images/furuno-logo.jpg', link: 'https://www.furuno.com/' },
    { category: 'industrialchain', name: 'Dockmate', logo: 'images/dockmate-logo.jpg', link: 'https://www.dockmate.us/' },
    { category: 'industrialchain', name: 'Maptattoo', logo: 'images/maptattoo.jpg', link: 'https://www.maptattoo.com/' },
    { category: 'industrialchain', name: 'Getorca', logo: 'images/getorca.jpg', link: 'https://www.getorca.com/' },
    { category: 'industrialchain', name: 'Victron Energy', logo: 'images/victronenergy.jpg', link: 'https://www.victronenergy.com/' },
    { category: 'industrialchain', name: 'Mastervolt', logo: 'images/mastervolt.jpg', link: 'https://www.mastervolt.com/' },
    { category: 'industrialchain', name: 'Fischer Panda', logo: 'images/fischerpanda.jpg', link: 'https://www.fischerpanda.de/' },
    { category: 'industrialchain', name: 'Cummins Onan', logo: 'images/cumminsonan.jpg', link: 'https://www.cummins.com/generators/marine' },
    { category: 'industrialchain', name: 'Volvo Penta', logo: 'images/volvopenta.jpg', link: 'https://www.volvopenta.com/' },
    { category: 'industrialchain', name: 'Yanmar Marine', logo: 'images/yanmarmarine.jpg', link: 'https://www.yanmar.com/global/marine/' },
    { category: 'industrialchain', name: 'VETUS', logo: 'images/vetus.jpg', link: 'https://www.vetus.com/' },
    ...
    // 帆船设计
    { category: 'design', name: 'Colin Archer', logo: 'images/colin-rcher.jpg', link: 'https://www.colin-archer.no/' },
    ...
    { category: 'design', name: 'Olin Stephens', logo: 'images/olin-stephens.jpg', link: 'https://www.sparkmanstephens.com/' },
    ...
    { category: 'design', name: 'Bill Tripp', logo: 'images/bill-tripp.jpg', link: 'https://www.trippdesign.net/' },
